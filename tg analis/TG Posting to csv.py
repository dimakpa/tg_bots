...
from telethon.tl.functions.messages import GetHistoryRequest
    ...
    #пытался записать в конфиг файл все данные
    ...
    #    'username': 'debocherry',
    #}
    #with open('TGkeys.ini', 'w') as configfile:
...
async def dump_all_participants(channel):
	...
	limit_user = 0   # максимальное число записей, передаваемых за один раз
...
async def dump_all_messages(channel):
	...
	limit_msg = 10   # максимальное число записей, передаваемых за один раз, НУЖНО МЕНЯТЬ ЭТО
